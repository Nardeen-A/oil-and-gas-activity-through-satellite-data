...
At the same time, the strong importance of spatial coordinates highlights a potential risk of spatial over fitting. Future work should therefore incorporate spatial cross-validation or out-of-region testing to ensure that the model generalizes beyond the observed training regions.
